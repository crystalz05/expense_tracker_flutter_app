...
class UploadProfilePhoto extends UseCase<UserProfile, File> {
  final UserProfileRepository repository;

  UploadProfilePhoto(this.repository);

  @override
  Future<Either<Failure, UserProfile>> call(File param) async {
    return repository.uploadProfilePhoto(param);
  }
}
