...
class GetMonthlyBudgetByDate extends UseCase<MonthlyBudget, BudgetDateParams> {

  final MonthlyBudgetRepository repository;

  GetMonthlyBudgetByDate(this.repository);

  @override
  Future<Either<Failure, MonthlyBudget>> call(BudgetDateParams param) {
    return repository.getMonthlyBudgetByDate(param);
  }
}
