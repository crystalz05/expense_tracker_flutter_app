...
class GetMonthlyBudgetByMonthYear implements UseCase<MonthlyBudget?, MonthYearParams> {
  ...
  Future<Either<Failure, MonthlyBudget?>> call(MonthYearParams params) async {
    return await repository.getMonthlyBudgetByMonthYear(params.month, params.year);
  }
}